...
define('SLIDE_OUT_CONTENT','<center><h2>Custom Left Slide Out</h2>You can add any content here, text, images, etc.<br /><br /><br /><br /><a href="index.php?main_page=specials"><img src="includes/templates/winchester_black/images/summer.png" alt="your alt text here" /></a></center>');
