<?php
/**
 * @package Winchester Black Template 1.7
 * @copyright Copyright 2003-2019 Zen Cart Development Team
 * @copyright Portions Copyright 2003 osCommerce
 * @license https://www.zen-cart-pro.at/license/3_0.txt GNU General Public License V3.0
 * @version $Id: init_winchester_black.php 2019-09-16 14:13:51Z webchills $
 */
...
// first check if an old Winchester version 1.4 for and old Zen Cart version is already installed
$oldwinchester = $db->Execute("SELECT configuration_value FROM " . TABLE_CONFIGURATION . " WHERE configuration_key = '" . WINCHESTER_BLACK_VERSION . "';");
if (($oldwinchester->RecordCount() > 0 ) && ($oldwinchester == '1.4' ))  {
// update version number to 1.6 first to prevent unneccessary and unwanted database operations
$db->Execute("UPDATE " . TABLE_CONFIGURATION . " SET configuration_value = '1.6' WHERE configuration_key = 'WINCHESTER_BLACK_VERSION' LIMIT 1;");
} else {
...
$module_constant = 'WINCHESTER_BLACK_VERSION'; 
$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/winchester_black'; 
$module_name = "Winchester Black"; 
