<?php
/* Winchester Black Template 1.7 Multilanguage Installer
 * @package admin
 * @copyright Copyright 2003-2018 Zen Cart Development Team
 * @copyright Portions Copyright 2003 osCommerce
 * @license http://www.zen-cart-pro.at/license/2_0.txt GNU Public License V2.0
 * @version $Id: 1_5.php 2019-09-16 14:34:14 webchills $
 */
 

 
$configuration = $db->Execute("SELECT configuration_group_id FROM " . TABLE_CONFIGURATION_GROUP . " WHERE configuration_group_title = '" . BOX_CONFIGURATION_WINCHESTER_BLACK . "' ORDER BY configuration_group_id ASC;");
...
WHERE configuration_group_title= 'Winchester Black'
LIMIT 1;");

$db->Execute("UPDATE " . TABLE_CONFIGURATION . " SET configuration_value = '1.5' WHERE configuration_key = 'WINCHESTER_BLACK_VERSION' LIMIT 1;");
...
$db->Execute("REPLACE INTO " . TABLE_CONFIGURATION_LANGUAGE . " (configuration_title, configuration_key, configuration_description, configuration_language_id) VALUES
('Winchester - Version', 'WINCHESTER_BLACK_VERSION', 'Read Only - Zeigt die installierte Winchester Black Version', 43),
...
$admin_page = 'configWinchester_Black';
...
LIMIT 1;");
$db->Execute("INSERT IGNORE INTO " . TABLE_ADMIN_PAGES . " (page_key,language_key,main_page,page_params,menu_key,display_on_menu,sort_order) VALUES 
('configWinchester_Black','BOX_CONFIGURATION_WINCHESTER_BLACK','FILENAME_CONFIGURATION',CONCAT('gID=',@gid),'configuration','Y',@gid)");
}
$messageStack->add('Winchester Black Template erfolgreich installiert', 'success');