### Winchester Black Template UNINSTALL ####
...
DELETE FROM configuration_group WHERE configuration_group_title = 'Winchester Black Template Configuration';
DELETE FROM configuration_group WHERE configuration_group_title = 'Winchester Black Template Konfiguration';
DELETE FROM configuration_group WHERE configuration_group_title = 'Winchester Black';

DELETE FROM admin_pages WHERE page_key='configWinchester_Black';

DELETE FROM configuration WHERE configuration_key = 'WINCHESTER_BLACK_VERSION';
...
DELETE FROM configuration_language WHERE configuration_key = 'WINCHESTER_BLACK_VERSION';
